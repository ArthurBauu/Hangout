    ...
    override fun onReceive(context: Context, intent: Intent)
    {
        ...
        private fun notifyNewContact(context: Context, contact: com.example.contactapp.Contact)
        {
            ...
            val notif = NotificationCompat.Builder(context, channelId)
                .setContentTitle(context.getString(com.example.contactapp.R.string.notif_new_contact_title))
                .setContentText(context.getString(com.example.contactapp.R.string.notif_new_contact_text, contact.phone))
